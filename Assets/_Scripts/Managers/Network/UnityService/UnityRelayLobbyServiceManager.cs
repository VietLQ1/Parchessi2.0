...
public class UnityRelayLobbyServiceManager : PersistentSingletonNetworkBehavior<UnityRelayLobbyServiceManager> 
{
    ...
    private void HandlePeriodicListLobbies() {
        if (_joinedLobby == null &&
            ...
            SceneManager.GetActiveScene().name == AssetSceneManager.AssetScene.LobbyScene.ToString()) {
    ...
    public async void CreateLobby(string lobbyName, bool isPrivate) {
        ...
        try {
            _joinedLobby = await LobbyService.Instance.CreateLobbyAsync(lobbyName, GameMultiplayerManager.MAX_PLAYER_AMOUNT, new CreateLobbyOptions {
                IsPrivate = isPrivate,
            });
